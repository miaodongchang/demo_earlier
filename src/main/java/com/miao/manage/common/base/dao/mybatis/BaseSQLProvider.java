...
public class BaseSQLProvider<T extends Entity> {
    ...
    private void initFromThreadLocal() {
        ...
        tableName = modelClass.getAnnotation(TableName.class).name();
    ...
    public String getCount(Map<String, Object> dataMap) {
    ...
    public String queryCount(Map<String, Object> customQueryParams) {
        initFromThreadLocal();
        SQL sql = COUNT_FROM();
